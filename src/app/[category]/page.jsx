        ...
        <div className="mx-auto max-w-7xl px-8 lg:px-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <h1 className=" relative w-fit  text-4xl   pb-3 lg:text-5xl font-black text-gray-900 ">
                {category}
                <span className="absolute w-12 h-2 bottom-0 left-0  bg-amber-600"></span>
              </h1>
            </div>
        ...
        {data?.length === 0 && (
          <div className="text-center ">
            ...
            <p className="text-gray-500 mt-2">
              Nous n'avons trouvé aucun produit dans la catégorie {category}.
            </p>
            <Link
              href="/"
              className="mt-6 inline-block bg-blue-700 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-800 transition"
            >
              Retour à l'accueil
            </Link>
          </div>
